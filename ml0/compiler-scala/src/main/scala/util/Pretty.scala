package com.todesking.ojaml.ml0.compiler.scala.util.pretty
...
object Doc {
  ...
  // Force-breaking group
  case class BGroup(doc: Doc) extends Doc {
    override def toString =
      s"![${doc}]"
  }
